...
class _$_HomeUnit extends _HomeUnit {
  ...
  @override
  String toString() {
    return 'HomeUnit(id: $id, name: $name, description: $description, thumbnail: $thumbnail, unitType: $unitType, numberOfUnits: $numberOfUnits, images: $images, live: $live, details: $details, features: $features, position: $position, analytics: $analytics, bookings: $bookings)';
  }
...
abstract class _HomeUnit extends HomeUnit {
  ...
  const factory _HomeUnit(
      ...
      LatLng position,
      Analytics analytics,
      List<Booking> bookings}) = _$_HomeUnit;
